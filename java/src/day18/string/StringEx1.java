...
public class StringEx1 {
	...
	public static void main(String[] args) {
		...
		//replaceAll : 정규 표현식(문자열에 특정패턴이있는지 없는지 체크 ex:id검사)
		//			   에 맞는 모든 문자/문자열을 수정
		...
		System.out.println(str+"에서 0 번지부터 "+"o"+"가 오른쪽부터 있나요");
		...
		//trim 시작문자(a), 마지막문자(f) 후 공백을 제거, 사이에 있는 공백은 제거 못함
		String str4="\n\t\tabc\t\tdef\t\n";
		System.out.println(str4.trim());
		
		//split : 구분자를 기준으로 문자열을 추출 해서 순서대로 배열에 저장해줌
		String str5 = "사과,배,포도";
