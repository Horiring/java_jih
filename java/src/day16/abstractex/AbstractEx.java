...
public class AbstractEx {
	...
	public static void main(String[] args) {
		...
		//ChildA1도 추상 클래스 이기 떄문에 ChildA1으로 객체를 생성할 수 없다.
		...
		//추상 클래스를  상속받은 ChildA2는 일반클래스이기떄문에 객체생성가능
		//모든 기능이 구현되어있다=> 객체생성가능
		//모든 기능이 구현되어 있지 않다 = >추상 메서드가있다=> 객체 생성이 불가능
